...
func (c *endServiceClient) DeNoise(ctx context.Context, in *TestReq, opts ...grpc.CallOption) (*DeNoiseResponse, error) {
	out := new(DeNoiseResponse)
	err := c.cc.Invoke(ctx, "/end.EndService/DeNoise", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *endServiceClient) Test(ctx context.Context, in *TestReq, opts ...grpc.CallOption) (*TestResponse, error) {
	out := new(TestResponse)
	err := c.cc.Invoke(ctx, "/end.EndService/Test", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedEndServiceServer) DeNoise(context.Context, *TestReq) (*DeNoiseResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeNoise not implemented")
}
func (UnimplementedEndServiceServer) Test(context.Context, *TestReq) (*TestResponse, error) {
...
func _EndService_DeNoise_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TestReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EndServiceServer).DeNoise(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/end.EndService/DeNoise",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EndServiceServer).DeNoise(ctx, req.(*TestReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _EndService_Test_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TestReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EndServiceServer).Test(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/end.EndService/Test",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EndServiceServer).Test(ctx, req.(*TestReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EndService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeNoise",
			Handler:    _EndService_DeNoise_Handler,
		},
		{
			MethodName: "Test",
			Handler:    _EndService_Test_Handler,
		},
	},
